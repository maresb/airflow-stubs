...
from airflow.www.extensions.init_security import init_api_experimental_auth as init_api_experimental_auth, init_check_user_active as init_check_user_active, init_xframe_protection as init_xframe_protection
...
app: None
def create_app(config: Incomplete | None = ..., testing: bool = ...): ...
def cached_app(config: Incomplete | None = ..., testing: bool = ...): ...
